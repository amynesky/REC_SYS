...
template < typename Dtype>
void gpu_get_rand_bools(const int n,  Dtype* x, unsigned long seed, float probability_of_success);
...
template <typename Dtype>
void gpu_shuffle_array(cublasHandle_t handle, const int n,  Dtype* x);
...
template<typename Dtype>
void gpu_set_all(  Dtype* x, const int n, const Dtype alpha);

void gpu_set_as_index(  int* x, const int n);

template<typename Dtype>
Dtype gpu_abs_max(const int n, const Dtype* x); 

template<typename Dtype>
Dtype gpu_min(const int n, const Dtype* x); 

template<typename Dtype>
Dtype gpu_max(const int n, const Dtype* x); 

template<typename Dtype>
Dtype gpu_range(const int n, const Dtype* x); 

template<typename Dtype>
Dtype gpu_sum(const int n,  const Dtype* x);

template<typename Dtype>
Dtype gpu_expected_value(const int n,  const Dtype* x);

template<typename Dtype>
Dtype gpu_expected_abs_value(const int n,  const Dtype* x);

template<typename Dtype>
Dtype gpu_variance(const int n, const Dtype* x);

template<typename Dtype>
Dtype gpu_sum_of_squares(const int n, const Dtype* x);

template <typename Dtype>
void gpu_dot(cublasHandle_t dn_handle, const int n, const Dtype* x, const Dtype* y, Dtype* out);

template <typename Dtype>
void gpu_asum(cublasHandle_t dn_handle, const int n, const Dtype* x, Dtype* y);
...
cublasStatus_t transpose(cublasHandle_t handle,
                         int m, int n, const Dtype *A, Dtype *result);
...
template <typename Dtype>
void gpu_hadamard(const int n, const Dtype* A, Dtype* B );

template <typename Dtype>
void gpu_axpy(cublasHandle_t dn_handle, const int N, const Dtype alpha, const Dtype* X,
                    Dtype* Y);

template <typename Dtype>
void gpu_axpby(cublasHandle_t dn_handle, const int N, const Dtype alpha, const Dtype* X,
...
template<typename Dtype>
Dtype gpu_sum_of_squares_of_diff(cublasHandle_t dn_handle, const int n, const Dtype* x, Dtype* y);
